...
Current highlights:
- Tidebound (working title) — a sea-bound exploration game about discovery and community.
- Experimental tech and open-source tools to speed development and empower creators.
...
## Tech & platforms
We primarily build with Unity and Godot, use C# and C++ where appropriate, and ship across PC and consoles where it fits the game. We also maintain small open-source tools for level editing and workflow automation.

## Contribute & follow
We welcome bug reports, playtesters, and creative collaboration.
- Check our repository issues for tasks labeled `good first issue` or `design help`.
...
## Contact
For press, partnerships, or business inquiries: contact@aengler-games.example (replace with real address)
